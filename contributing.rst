...
.. _create a new issue: https://github.com/mristin/thonny-icontract-hypothesis/issues/new/choose
...
Manual Testing
==============
You can manually test by starting Thonny from the command line in your virtual environment:

.. code-block::

    thonny path/to/some/file.py

The plug-in should be automatically activated.
